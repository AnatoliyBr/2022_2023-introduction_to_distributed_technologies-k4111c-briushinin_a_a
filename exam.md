...
---
### 19. Сложность сети, размер блока, очередь транзакций (дописать с сайта)
...
---
### 20. Проблема двойной траты, параметры транзакции, пропускная способность сети (дописать с сайта)
...
**EVM** - эфировская виртуальная машина (ВМ) может получать данные о предыдущем состоянии блокчейна и помещать ее в следующее состояние. Похожа на [ВМ Java(JVM)](https://help.reg.ru/support/servery-vps/oblachnyye-servery/ustanovka-programmnogo-obespecheniya/virtualnaya-mashina-java), то есть работает одинаково на любом железе.
