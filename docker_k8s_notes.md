...
* Псевдонимы (alias'ы) - `alias k="kubectl"` и т.д.
* [kubectl-debug](https://github.com/JamesTGrant/kubectl-debug)
    * командная оболочка контейнеров в Pod имеет весьма ограниченный набор утилит, часто не хватает netstat/ip/ping/curl/wget
* [Lens](https://k8slens.dev/) - IDE для K8S
* [ktx](https://github.com/blendle/kns) - инструмент быстрого переключения между кластерами
* kns - quick K8S Namespace Switcher
* Debug map  
![k8s Debug map](https://github.com/AnatoliyBr/2022_2023-introduction_to_distributed_technologies-k4111c-briushinin_a_a/blob/master/images/debug_map.png 'k8s Debug map')
